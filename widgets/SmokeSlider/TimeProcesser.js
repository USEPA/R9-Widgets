...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/config', 'dojo/Evented', 'dijit/_WidgetBase', 'dojo/when', 'dojo/promise/all', 'dojo/Deferred', 'esri/request', './utils', 'moment/moment', 'dojo/date/locale', 'dojo/i18n', 'esri/lang', 'esri/TimeExtent'], function (declare, lang, dojoConfig, Evented, _WidgetBase, when, all, Deferred, esriRequest, utils, moment, dateLocale, i18n, esriLang, TimeExtent) {
  ...
  var clazz = declare([_WidgetBase, Evented], {
    ...
    getCurrentTimeStops: function getCurrentTimeStops(timeStamp) {
      var startTime = null,
          endTime = null;
    ...
    //Auto Refresh
    setAutoRefreshTimer: function setAutoRefreshTimer(ref) {
    ...
    restoreAutoRefreshTimer: function restoreAutoRefreshTimer(timeSlider) {
...
//# sourceMappingURL=TimeProcesser.js.map
