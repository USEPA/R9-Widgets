...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/array', 'dojo/Evented', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./SpeedMenu.html', 'dojo/on', 'dojo/query', 'jimu/utils', "./a11y/SpeedMenu"], function (declare, lang, html, array, Evented, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, on, query, jimuUtils, a11y) {
  // box of speed-menu
  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _onSelectSpeedItem: function _onSelectSpeedItem(evt) {
    ...
    //speed menu
    _setMenuPosition: function _setMenuPosition() {
    ...
    _onSpeedLabelClick: function _onSpeedLabelClick(evt) {
      evt.stopPropagation();
      evt.preventDefault();
    ...
    _showSpeedMenu: function _showSpeedMenu() {
    ...
    _closeSpeedMenu: function _closeSpeedMenu() {
...
//# sourceMappingURL=SpeedMenu.js.map
