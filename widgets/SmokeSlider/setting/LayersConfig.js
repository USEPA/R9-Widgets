...
define(['dojo/Evented', 'dojo/_base/declare', 'dojo/_base/lang', "esri/lang", 'dojo/_base/html', 'dojo/_base/array', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', "dijit/_WidgetsInTemplateMixin", 'dojo/on', "dojo/text!./LayersConfig.html", 'jimu/LayerInfos/LayerInfos',
//'moment/moment',
"../utils", 'jimu/utils', "jimu/dijit/CheckBox"], function (Evented, declare, lang, esriLang, html, array, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, on, template, LayerInfos, /* moment,*/utils, jimuUtils, CheckBox) {
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    */
    startup: function startup() {
      ...
      LayerInfos.getInstance(this.map, this.map.itemInfo).then(lang.hitch(this, function (layerInfosObj) {
        ...
        array.forEach(infos, lang.hitch(this, function (info) {
          ...
          var isTimeLayer = esriLang.isDefined(info.layerObject.timeInfo) && esriLang.isDefined(info.layerObject.timeInfo.timeExtent);
          if (isTimeLayer) {
            this.addARow(info);
          }
        }));
    ...
    //   this.emit('initTimeExtent', this.getFullTimeExtent());
    // },
    _creatTableRow: function _creatTableRow(container, layerName, timeInfo) {
    ...
    addARow: function addARow(layerInfo) {
    ...
    getFullTimeExtent: function getFullTimeExtent() {
