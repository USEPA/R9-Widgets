...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', "jimu/BaseWidgetSetting", "dijit/_WidgetsInTemplateMixin", 'dojo/on', "dojo/text!./TimeConfig.html", "../utils", './TimeCalendar', 'esri/TimeExtent', "jimu/dijit/CheckBox", "dijit/form/Select", "dijit/form/ValidationTextBox"], function (declare, lang, html, BaseWidgetSetting, _WidgetsInTemplateMixin, on, template, utils, TimeCalendar, TimeExtent, CheckBox, Select) {
  var clazz = declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    */
    ...
    updateConfigByLyaers: function updateConfigByLyaers(config) {
      if ("undefined" !== typeof config.startTime) {
        this.startTimeCalendar.setConfig(config.startTime.timeConfig);
      }
      if ("undefined" !== typeof config.endTime) {
    ...
    _updateInterval: function _updateInterval(evtType) {
    ...
    isValid: function isValid() {
      ...
      if (startTime.valueOf() > endTime.valueOf()) {
        if (!hadError) {
          //avoid to popup too many errors
    ...
    _cleanErrorTips: function _cleanErrorTips() {
      html.removeClass(this.timeConfigContainer, "error");
    },
    ...
    getLayersTimeExtent: function getLayersTimeExtent() {
      var te = this.parent.getLayersTimeExtent();
      return te;
    },

    //read only falg
    _setKeepValueFlag: function _setKeepValueFlag(flag) {
      this._KEEP_VALUE_FLAG = flag;
    },
    _getKeepValueFlag: function _getKeepValueFlag() {
...
//# sourceMappingURL=TimeConfig.js.map
