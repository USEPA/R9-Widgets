...
define(['dojo/Evented', 'dojo/_base/declare', 'dojo/_base/lang', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', "dijit/_WidgetsInTemplateMixin", 'dojo/on', "dojo/text!./ConfigureTimeSettings.html", './LayersConfig', './TimeConfig', "jimu/dijit/CheckBox", "dijit/form/Select", "dijit/form/ValidationTextBox"], function (Evented, declare, lang, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, on, template, LayersConfig, TimeConfig) {
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    */
    ...
    getConfig: function getConfig(settingConfig) {
      ...
      if (settingConfig.customTimeConfig.startTime.timeConfig.time) {
        settingConfig.customTimeConfig.startTime.timeConfig.time = new Date(settingConfig.customTimeConfig.startTime.timeConfig.time).getTime();
      }
      if (settingConfig.customTimeConfig.endTime.timeConfig.time) {
        settingConfig.customTimeConfig.endTime.timeConfig.time = new Date(settingConfig.customTimeConfig.endTime.timeConfig.time).getTime();
      }
...
//# sourceMappingURL=ConfigureTimeSettings.js.map
