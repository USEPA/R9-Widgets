...
define(['dojo/_base/declare', 'jimu/BaseWidgetSetting', 'dijit/_WidgetsInTemplateMixin', 'dojo/on', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/keys', 'dojo/Deferred', 'jimu/utils', './ConfigureTimeSettings',
//'./AutoRefresh',
'jimu/dijit/Popup', "jimu/dijit/CheckBox", "dijit/form/Select", "dijit/form/ValidationTextBox"], function (declare, BaseWidgetSetting, _WidgetsInTemplateMixin, on, lang, html, keys, Deferred, jimuUtils, ConfigureTimeSettings, /*AutoRefresh, */Popup, CheckBox, Select /* ,ValidationTextBox*/) {
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    */
    ...
    _initOptionsUI: function _initOptionsUI(val, customDateFormatVal) {
      if (val !== "Custom") {
    ...
    _onPopupOk: function _onPopupOk() {
    ...
    getConfig: function getConfig() {
      ...
      if (this.webMapSettingRaido.checked) {
        ...
        // this.configureSettingRaido.checked = true;
    ...
    _onCustomDateFormatBlur: function _onCustomDateFormatBlur() {
      this.customDateFormat.value = jimuUtils.stripHTML(this.customDateFormat.value || "");
    },
    _updateTimeSettingBtnUI: function _updateTimeSettingBtnUI() {
      if (this.webMapSettingRaido.checked) {
    ...
    _createTimeConfigSetting: function _createTimeConfigSetting() {
