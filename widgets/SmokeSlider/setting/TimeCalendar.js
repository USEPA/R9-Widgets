...
define(['dojo/Evented', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', "dijit/_WidgetsInTemplateMixin", 'dojo/on', "dojo/text!./TimeCalendar.html", "../utils", "dijit/form/DateTextBox", "dijit/form/TimeTextBox", "dijit/form/Select", "dijit/form/NumberSpinner", "dijit/form/ValidationTextBox", "jimu/dijit/CheckBox"], function (Evented, declare, lang, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, on, template, utils, DateTextBox, TimeTextBox, Select) {
  var clazz = declare([Evented, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    */
    ...
    toggleTimeMode: function toggleTimeMode(mode, isTriggerEvent) {
    ...
    _getMaxOrMinTime: function _getMaxOrMinTime() {
      var timeExtent = this.parent.getLayersTimeExtent();
      if (timeExtent) {
        this.setMaxMinTime(timeExtent);
      }
    },
    setMaxMinTime: function setMaxMinTime(config) {
      var time;
      if (this.mode === "min") {
    ...
    getConfig: function getConfig() {
      ...
      if (this.modeOptions.getValue() === "time") {
        ...
        if (date && time) {
          ...
          fullDate = new Date(date.getFullYear(), date.getMonth(), date.getDate(), time.getHours(), time.getMinutes(), time.getSeconds());
        } else {
          fullDate = null;
        }
      } else if (this.modeOptions.getValue() === "max" || this.modeOptions.getValue() === "min") {
    ...
    _updateTimeModeValue: function _updateTimeModeValue() {
...
//# sourceMappingURL=TimeCalendar.js.map
