...
class Widget implements IWidget {
  ...
  private loadFacility(facility: any) {
    this.myNode.innerHTML = `<b>PWS ID:</b>` + ` `+  facility.attributes.Fac_PWSID + '</br>' + `<b>PWS Name:</b>` + ` `+ facility.attributes.Fac_PWS_Name + '</br>'+
      ...
      `<b><p style="text-align: center;">Additional PWS Details</p></b>`+ `</br>`+ `<hr />`+`</br>`+ `<b>City Served:</b>` + `</br>`+ `<b>County Served:</b>`+`PWS Attribute`+ `</br>`+`<b>State:</b>`+`PWS Attribute`+ `</br>`+`<b>Tribe Name:</b>` +`</br>`+`PWS Attribute`+ `<b>PWS Population Served Category:</b>`+`</br>`+`PWS Attribute`+`<b>Is the PWS a School or Daycare?</b>`+`PWS Attribute`+`</br>`+`<b>PWS Owner Type:</b>`+`PWS Attribute`+`</br>`+ `<b>Is PWS Wholesaler to Another PWS?</b>`+`PWS Attribute`+`</br>` +`<b>PWS Source Water Type:</b>`+`PWS Attribute`+`</br>`+`<p style="text-align: center;">&nbsp;</p> <table style="height: 98px; background-color: #ffcccb; border-color: #000000; margin-left: auto; margin-right: auto;" width="100%">
        <tbody><tr><td style="text-align: center; width: 287px;"><strong>Regulatory Agency</strong></td></tr><tr style="text-align: center;">`+`<td style="width: 287px;">Name of Regulatory Agency (PWS Attribute)</td>
        </tr><tr style="text-align: center;"><td style="width: 287px;">PHONE - EMAIL</td></tr><tr style="text-align: center;">
        <td style="width: 287px;">ADDRESS</td></tr></tbody></table><p>&nbsp;</p>`+`</br>`+
