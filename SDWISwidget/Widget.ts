...
class Widget implements IWidget {
  ...
  private _clickHandler() {
    ...
    this.myNode.innerHTML = `<p style="font-size:16px"><b>Public Water System (PWS)</b></p>`+ `<b><p style="font-size:14px">Name:</b>` + ` `+ facility.attributes.Fac_PWS_Name +`</br>`+`<b>ID:</b>` + ` `+  facility.attributes.Fac_PWSID + '</p>' +`<p style="text-align: center;">&nbsp;</p> <table style="height: 98px; background-color: #ffffce; border-color: #000000; margin-left: auto; margin-right: auto;" width="100%">
