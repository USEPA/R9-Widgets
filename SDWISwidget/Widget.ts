...
class Widget implements IWidget {
  ...
  private _clickHandler() {
    ...
    this.myNode.innerHTML = `<b>PWS ID:</b>` + ` `+  facility.attributes.Fac_PWSID + '</br>' + `<b>PWS Name:</b>` + ` `+ facility.attributes.Fac_PWS_Name + '</br>'+
      ...
      <b><p style="text-align: center;">Water System Facility Information</p></b>` + `<hr />`+ `<b>Facility Name:</b>` + ` `+  facility.attributes.FacilityName + '</br>' + `<b>Facility Type:</b>` + ` `+ facilitytype + '</br>' + `<b>Source Type:</b>` + ` `+  sourcetype +`</br>`+ `<b>Source Treated:</b>`+ ` `+ facility.attributes.FacSourceTrtStatus + `</br>`+ `<b>Facility Availability:</b>`+ ` `+ availability +`</br>` + `<b>Last Updated:</b>` +` `+ facility.attributes.Last_Reported +`</br>`+'<b>PWS Purchased From: </b>'+ facility.attributes.PWSID_SELLER + `</br>` + `<b>Purchased Water Treated:</b>`+` `+ sellertreated +`</br>` + `<p style="text-align: center;">&nbsp;</p>`+`</br>`  +`<p style="text-align: center;"><a href="https://echo.epa.gov/detailed-facility-report?fid=${facility.attributes.Fac_PWSID}" target="_blank">ECHO DFR (PWS Level)</a></p> `+` </br> `+` </br>` ;
    this.loadingShelter.hide();
...
// , Pulls in PWS information from PWS points layer
  ...
  private loadFacilityTable(PAcode: any) {
   ...
   var table = `<p style="text-align: center;">${facilityTable.attributes.RegAuthority}</p>`+`</br>`+`<p style="text-align: left;"><b>Primary Contact: </b>`+` ${facilityTable.attributes.PrimaryContactName}`+`</br>`+`<b>Phone: </b>`+` ${facilityTable.attributes.Phone_Number}`+`</br>`+`<b>Email: </b>`+`<a href="mailto:${facilityTable.attributes.Email}">${facilityTable.attributes.Email}</a> `+`</br>`+`<b>Website: </b>`+`<a href="${facilityTable.attributes.Website}" target="_blank">Click Here for Website</a>`+`</br>`+`<b>Address: </b>`+`${facilityTable.attributes.Mailing_Address}</p>`
  ...
  private loadFacilityAdmin(pwsid: any) {
    ...
    this.featureLayerAdmin.queryFeatures(query, (featureSet: FeatureSet) => {
      ...
      var admin = `<p style="text-align: left;">`+`<b>POC Name: </b>${facilityAdmin.attributes.org_name}`+`</br>`+`<b>Phone: </b> ${facilityAdmin.attributes.phone_number}`+`</br>`+`<b>Email: </b> <a href="mailto:${facilityAdmin.attributes.email_addr}">${facilityAdmin.attributes.email_addr}</a>`+`</br>`+`<b>Address: </b> ${facilityAdmin.attributes.address_line1}`+`</br>`+`${facilityAdmin.attributes.city_name}`+`, `+`${facilityAdmin.attributes.state_code}`+`, `+`${facilityAdmin.attributes.zip_code}`
