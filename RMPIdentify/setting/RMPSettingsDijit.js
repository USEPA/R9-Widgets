...
define([
    ...
    'dijit/form/ComboBox',
    'dojo/text!./RMPSettingsDijit.html',
    'dojo/_base/lang',
    'dojo/_base/array',
    'dojo/on',
    'dojo/query',
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      postCreate: function () {
        if (this.config !== undefined) {
          ...
          this.facilitySelectNode.innerHTML = " : " + this.config.layerName;
      ...
      _createNewQuerySourceSettingFromMenuItem: function (setting, definition) {
        ...
        querySetting.own(
          on(querySetting, 'select-query-source-ok', lang.hitch(this, function (item) {
            ...
            this.facilitySelectNode.innerHTML = item.name;
            // will need to be adjusted if used with different states
