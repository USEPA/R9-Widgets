...
define(['dojo/_base/declare',
    ...
    './utils',
    "dojo/throttle",
    'esri/moment', 'dojo/request', 'esri/layers/MapImageLayer',
    'esri/layers/MapImage', 'dojo/string',
  ],
  function (declare, lang, html, array, baseFx, WidgetManager, Move,
            on, query, Deferred, domGeometry,
            LayerInfos, BaseWidget, TimeExtent,
            jimuUtils, _TimeSlider, utils, throttle,
            moment, request, MapImageLayer, MapImage, string) {
    ...
    var clazz = declare([BaseWidget], {
      ...
      root_url: './widgets/Smoke/images/${start_timestamp}/${image_timestamp}.png',
      images: {},
      _getImages: function (start_timestamp, image_timestamp) {
        var vm = this;
      ...
      postCreate: function () {
        ...
        this._getImages(this.start.clone()).then(function () {
          ...
          vm.timeSliderUI.setTimeExtent(vm.timeExtent);
        });
        ...
        this.timeSliderUI = new _TimeSlider({
          nls: this.nls,
          config: this.config,
          map: this.map,
      ...
      onOpen: function () {
        ...
        //   } else {
        //     if (!this._showed) {
        this.timeSliderUI.showTimeSlider();
        //   }
        // }
        this.timeSliderUI.timeSlider.on('time-extent-change', function (timeExtent) {
        ...
        // this.timeSliderUI._adaptResponsive();
        var vm = this;
...
//         this.sliderNode = html.create('div', {}, this.sliderNodeContainer);
      ...
      onClose: function () {
        ...
        //   }
        // }));
        this.timeSliderUI.closeTimeSlider();
