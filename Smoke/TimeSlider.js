...
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/html', 'dojo/_base/array', 'dojo/_base/fx', "jimu/WidgetManager", 'dojo/dnd/move', 'dojo/on', 'dojo/query', 'dojo/Deferred', 'dojo/dom-geometry', 'jimu/LayerInfos/LayerInfos', 'jimu/BaseWidget', 'esri/TimeExtent', 'esri/dijit/TimeSlider', './SpeedMenu', 'jimu/utils', './TimeProcesser',
// './LayerProcesser',
'./utils', "dojo/throttle", 'esri/moment', 'dojo/request', 'esri/layers/MapImageLayer', 'esri/layers/MapImage', 'dojo/string', 'dojo/Evented', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'dojo/text!./TimeSlider.html'], function (declare, lang, html, array, baseFx, WidgetManager, Move, on, query, Deferred, domGeometry, LayerInfos, BaseWidget, TimeExtent, TimeSlider, SpeedMenu, jimuUtils, TimeProcesser, utils, throttle, moment, request, MapImageLayer, MapImage, string, Evented, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template) {
  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    postCreate: function postCreate() {
      ...
      //   vm.timeExtent = new TimeExtent(
      //     vm.start.clone().add(1, 'hour').toDate(),
      //     vm.start.clone().add(69, 'hour').toDate()
      //   );
      // });
    ...
    setTimeExtent: function setTimeExtent(timeExtent) {
